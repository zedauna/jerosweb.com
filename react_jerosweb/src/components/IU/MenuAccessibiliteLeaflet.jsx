export const MenuAccessibiliteLeaflet = () => {
  return (
    <div>
        {/* Menu d'accessibilité */}
    <ul className="a11y-nav">
        <li>
            <a href="#explication_leaflet">Mode d'emploi</a>
        </li>
        <li>
            <a href="#afficher_positions">Informations sur les positions</a>
        </li>
        <li>
            <a href="#ChargerData">Chargement des données</a>
        </li>
        <li>
        ...
        <li>
            <a href="#active_routing">Aller à la fonctionnalité routing</a>
        </li>
        <li>
            <a href="#active_geo">Aller à la fonctionnalité géocodage et géodécodage</a>
        </li>
        <li>
            <a href="#map">Aller à la carte leaflet</a>
        </li>
    </ul>
