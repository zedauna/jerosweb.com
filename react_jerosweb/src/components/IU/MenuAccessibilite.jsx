export const MenuAccessibilite = () => {
  return (
    <div>
      ...
      <ul className="a11y-nav">
        ...
        <li>
          <a href="#afficher_locate">
            Localisation de votre emplacement actuel
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="#navigation_button">
            Aller à la fonctionnalité navigation de la carte
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="#dep_centroid_result">
            cocher ou décocher centroïds des départements
          </a>
        </li>
      </ul>
      ...
      {/* message de pasage */}
      <div id="paysage">
        ⚠️ Attention, Votre écran est trop petit pour l'affichage, paysage
        possible où sur ordinateur. Merci !
      </div>
    </div>
  );
};
