        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ol>
                    ...
                    <li style="font-weight: bold;">Localisation : </li>

                    <p>Cette fonctionnalité recupère votre position sous votre accord et ensuite remplie les champs

                    de saisie de la fonctionnalité <span style="color:tomato;">Proximité</span>

                    pour calculer et afficher le point le plus proche de votre position actuelle.</p> 



                    <li style="font-weight: bold;">Distance : </li>

                    <p>Cette fonctionnalité permet de calculer la distance entre deux points choisis par
                    ...
                    <p>Cette fonctionnalité permet de calculer le centre entre deux points par
                    ...
                    <li style="font-weight: bold;">Proximité : </li>

                    <p>Cette fonctionnalité permet de calculer à partir de latitude et longitude saisie,

                        le point le plus proche de cette position et l'afficher sur la carte</p>
