...
window.addEventListener("load", () => {
  chargerDonnees("/public/02_page_svg_v2/php/map_france.php").then(function (response) {
...
function line_svg(p1, p2) {
  ...
  var nou = document.createElementNS(SVG_NS, "path");
  ...
  var p1x = parseFloat(p1.cX);
  var p1y = parseFloat(p1.cY);
  var p2x = parseFloat(p2.cX);
  var p2y = parseFloat(p2.cY);
  var mpx = (p2x + p1x) * 0.5;
  var mpy = (p2y + p1y) * 0.5;
