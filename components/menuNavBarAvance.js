export default class MenuNavBarAvance extends HTMLElement {
  connectedCallback() {
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="../index.html">SVG</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../02_page_leaflet/index.html">LEAFLET</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="index.php">SVG AVANCÉ</a>
                </li>
                <li class="nav-item">
